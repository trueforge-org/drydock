...
describe('Mock Trigger', () => {
  ...
  test('should trigger with container', async () => {
    ...
    expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('MOCK triggered title'));
    expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('MOCK triggered body'));
  });
